...
public static class Mappings
{
    ...
    public static CategoriaDto ToDto(this Categoria c) =>
        new(c.Id, c.Nombre, c.Tipo, c.Presupuesto, c.Emoji, c.FechaVencimiento, c.CuotasRestantes, c.MontoTotal, c.Activo, c.Orden);
    ...
    public static MovimientoDto ToDto(this Movimiento m) =>
        new(m.Id, m.PeriodoId, m.CategoriaId, m.Concepto, m.Tipo, m.Fecha, m.Monto, m.Nota, m.UsuarioId);
